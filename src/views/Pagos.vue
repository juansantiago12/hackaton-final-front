         ...
         <div class="row">
            <div class="col-sm-8 col-12 mx-2 medida">
               <h2 style="font-size: 23px" class="fw-bold mt-4">
                  <i class="fas fa-arrow-left"></i><span class="mx-3">Pasarela de Pagos</span>
               </h2>
              ...
              "
               ...
               <form :style="elemento1">
                ...
                "
                  ...
                  <div class="mb-3 form-check mx-2">
                     ...
                     <label class="form-check-label" for="exampleCheck1">Solicitar factura</label>
                  </div>
               </form>
               <form :style="elemento3">
                  ...
                  <p style="font-size: 15px; margin-bottom: 50px">
                     Enviaremos un código de pago CIP a tu correo electrónico, con el cual podrás
                  ...
                  <p>
                     Paga por internet vía transferencia desde el aplicativo móvil o web de tu banco
                     de preferencia
                  </p>
                  <div>
                     <img src="../assets/digital-1-bbva.png" alt="" style="width: 90px" />
                     <img
                  ...
                  <p>
                     Realiza depósitos en efectivo en agencias bancarias, agentes o bodegas a nivel
                     nacional.
                  </p>
                  <div>
                     <img src="../assets/digital-1-bbva.png" alt="" style="width: 90px" />
               ...
               <div :style="elemento2">
                  ...
                  <h2 style="font-weight: bold; font-size: 15px">Pasos a seguir:</h2>
                  <p style="font-size: 15px; margin-bottom: 50px">
                     Dar click en el boton de PAYPAL e ingresar con su cuenta para poder proceder a
                     hacer el pago:
                  </p>
                  <div class="container">
                     <paypal
            ...
            <section class="col-sm-4 col-12 wenas2 wenasCelular">
               ...
               >
                  <div class="row mt-5" v-for="curso in cursoAgregado" :key="curso.id">
                     <img :src="curso.image" alt="" class="col-6 imagenCarrito" />
                     <h3 class="fs-6 col-6 letraNomCell" style="width: 250px">
                        {{ curso.nombre }}
                     </h3>

                     <p style="margin-left: 320px; margin-top: -30px" class="letraNomPrecio">
                        S/.{{ curso.precio }}
                     </p>
                  </div>
            ...
            <button type="submit" class="btn btn-primary button" @click="finalizar()">
               Finalizar Compra
            </button>
         </div>
      </div>
         ...
         .Buttons({
            ...
            onApprove: function(data, actions) {
               ...
               return actions.order.capture().then(function(details) {
                  ...
                  swal(
                     'pago exitoso  ' + details.payer.name.given_name,
